...
# Get actual winners from y_test
actual_winners_lin = y_test.idxmax(axis=1).values

# Create comparison DataFrame
comparison_df = pd.DataFrame({
    'Actual Winner': actual_winners_lin,
    'Predicted Winner': predicted_winners_lin
})

print("First 5 comparisons (Linear Regression):")
print(comparison_df.head())

# print(df.tail(1)) # Removed as per user's likely intent to focus on results comparison